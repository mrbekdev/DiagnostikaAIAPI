...
export declare class DiagnosticsController {
    ...
    listExaminations(status?: ExaminationStatus, riskLevel?: RiskLevel, patientId?: string, skip?: number, take?: number): Promise<{
        total: number;
        skip: number;
        take: number;
        data: ({
    ...
    streamDiagnosticFile(key: string, res: any): Promise<void>;
}
