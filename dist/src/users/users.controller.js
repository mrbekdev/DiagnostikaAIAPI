...
__decorate([
    (0, common_1.Get)(),
    (0, roles_decorator_1.Roles)(client_1.UserRole.SUPER_ADMIN, client_1.UserRole.ADMIN, client_1.UserRole.DOCTOR),
    (0, swagger_1.ApiOperation)({ summary: 'Foydalanuvchilar / Shifokorlar ro‘yxatini olish' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Bitta foydalanuvchi ma’lumotlarini olish' }),
...
__decorate([
    (0, common_1.Put)(':id'),
    (0, roles_decorator_1.Roles)(client_1.UserRole.SUPER_ADMIN, client_1.UserRole.ADMIN),
    (0, swagger_1.ApiOperation)({ summary: 'Foydalanuvchi ma’lumotlarini yangilash' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Foydalanuvchini faolsizlantirish' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
